/**
 * Page: /capabilities
 * 02b Capability Register — 9 capabilities derived from Böhmer Systemtechnik's functional promise.
  ...
  return (
    <section id="section-02b" className="container">
      ...
      <div className="section-meta">
        ...
        <span className="sep">/</span>
        <span>Product Business Launch</span>
      </div>
      ...
      <div className="md">
        ...
        <div className="answer-box" id="cap-summary">
          ...
          <p className="answer">
            This chapter maps the {capabilities.length} capabilities derived from Böhmer
            Systemtechnik's functional promise — {coreCount} core (differentiating) +{" "}
            {supportingCount} supporting (table stakes). Capabilities are decomposed from what
            Böhmer must be able to <em>do</em> in order to deliver the promise: produce
            dimensionally precise, structurally sound welded steel assemblies with repeatable
            quality across carbon steel, stainless steel, and aluminum — and transform that
            fabrication capability into complete own-brand equestrian products. These capabilities —
        ...
        <blockquote>
          <p><strong>Component:</strong> Capability Register (Step 02b)</p>
          <p><strong>Upstream:</strong> 01 Capability Assessment, 02 Functional Promise, 00 Company Profile</p>
          <p><strong>Guiding Question:</strong> What specific capabilities can be derived from Böhmer's functional promise, and which adjacency targets do they enable?</p>
        </blockquote>
        ...
        <p>
          ...
          <strong>
            "Produce dimensionally precise, structurally sound welded steel assemblies with
            repeatable quality — then integrate them into complete equestrian products that address
            real stable operator needs (horse safety, tractor mobility, 15-year outdoor service
            life)."
          </strong>
        </p>
        <p>
          Capabilities are derived by decomposing what Böhmer must be able to <em>do</em> in order
        ...
        <p>
          The critical insight for Böhmer: capabilities C1–C3 (the fabrication stack) are the
          foundation, but <strong>C4 (system integration)</strong> and{" "}
          <strong>C5 (equestrian domain expertise)</strong> are what transform a job-shop into a
          product business. The fabrication capabilities are widely available — the combination with
          C4+C5 is not.
        </p>
        ...
        <p>
          {coreCount} core capabilities + {supportingCount} supporting capabilities —{" "}
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: 11, color: "var(--text-gray)", marginTop: 2 }}>
                Use capability as-is — no new capability needed
              </div>
            </div>
